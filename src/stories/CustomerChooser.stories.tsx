...
function CustomerChooserWrapper(){
  ...
  const [selected, setSelected] = useState<CustomerDto | undefined>()
  return (<CustomerChooser selected={selected} setSelected={setSelected} customers={customers}></CustomerChooser>)
}
